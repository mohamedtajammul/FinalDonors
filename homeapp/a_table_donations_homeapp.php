...
$sql = "SELECT * FROM homeappliance where status=1 ORDER BY date DESC";
...
<body style="background-color:#515151;">
    ...
    <div id="div1"><button class="btn btn-primary" type="button" data-bs-hover-animate="pulse" style="font-family:Montserrat, sans-serif;" onclick="location.href='http:a_table_donations_homeapp1.php'">VIEW OLD DONATIONS</button></div>
    ...
    echo " <td><button class='btn btn-primary' type='button' data-bs-hover-animate='pulse' onclick=\"location.href='http:hdelete.php?link=$ha_id&set=1'\">delete</button></td>";
	echo "</tr>";
    }
} else {
