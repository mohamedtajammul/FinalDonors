...
$sql = "SELECT * FROM food where status=0 ORDER BY date DESC";
...
<body style="background-color:#515151;">
    ...
    <div id="div1"><button class="btn btn-primary" type="button" data-bs-hover-animate="pulse" style="font-family:Montserrat, sans-serif;" onclick="location.href='http:a_table_donations_food.php'">VIEW NEW DONATIONS</button></div>
    ...
    echo " <td><button class='btn btn-primary' type='button' data-bs-hover-animate='pulse' onclick=\"location.href='http:fdelete.php?link=$f_id&set=0'\">delete</button></td>";
	echo "</tr>";
    }
} else {
