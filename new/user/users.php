...
<body style="background-color:#515151;">
        ...
        <div class="container-fluid"><a class="navbar-brand" href="../admin_home.html" data-bs-hover-animate="pulse" style="font-family:Aldrich, sans-serif;color:#ffa500;">YELLOW BIT DONORS</a><button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div
                ...
                <ul class="nav navbar-nav" style="font-family:Montserrat, sans-serif;">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link" href="../contact/a_table_contact.php" style="color:#ffa500;">MESSAGES</a></li>
                </ul>
        </div>
        </div>
    </nav>
    <h1 style="font-family:Montserrat, sans-serif;color:#ffa500;">USERS</h1>
    <div id="div1"><a class="btn btn-primary" role="button" href="admin_signup.html" data-bs-hover-animate="pulse" style="font-family:Montserrat, sans-serif;">ADD NEW USER</a></div>
        ...
        <table class="table">
            <thead>
                <tr style="background-color:#ffa500;">
                    ...
                    <th style="color:rgb(0,0,0);">PH. NUMBER</th>
                    <th></th>
                    <th></th>
                </tr>
            </thead>
    ...
    while($row = mysqli_fetch_assoc($result)) {
		$u_id=$row["u_id"]; $name=$row["name"]; $address=$row["address"];$phno=$row["phno"];$email=$row["email"];$password=$row["password"];
			  ...
			  echo  "<td>". $password ."</td>";
			  echo  "<td>". $phno ."</td>";
              echo  "<td><button class='btn btn-primary' type='button' data-bs-hover-animate='pulse' onclick=\"location.href='http:deleteuser.php?link=$u_id'\">delete</button></td>";
			  echo  "<td><button class='btn btn-primary' type='button' data-bs-hover-animate='pulse' onclick=\"location.href='http:edituser.php?link=$u_id'\">edit</button></td>";
	          echo  "</tr>";
			  }
			}else{
				echo "no users";
