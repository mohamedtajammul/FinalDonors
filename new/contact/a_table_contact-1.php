...
$sql = "SELECT * FROM contact where status=0 ORDER BY date DESC;";
...
<body style="background-color:#515151;">
    ...
    <h1 style="font-family:Montserrat, sans-serif;color:#ffa500;">VIEWED MESSAGES</h1>
    <div id="div1"><button class="btn btn-primary" type="button" data-bs-hover-animate="pulse" style="font-family:Montserrat, sans-serif;" onclick="location.href='http:a_table_contact.php'">VIEW NEW MESSAGES</button></div>
    ...
    echo " <td><button class='btn btn-primary' type='button' data-bs-hover-animate='pulse' onclick=\"location.href='http:delete_co.php?link=$c_id'\">delete</button></td>";
	echo "</tr>";
    }
} else {
    echo "No Contacts";
